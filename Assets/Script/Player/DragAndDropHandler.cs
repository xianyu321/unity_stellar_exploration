...
public class DragAndDropHandler : MonoBehaviour
{
    ...
    private void HandleSlotClick(UIItemSlot clickedSlot){
        ...
        if(cursorSlot.hasItem && clickedSlot.hasItem){
            if(cursorItemSlot.GetItemID() != clickedSlot.GetItemID()){
                ItemStack tempStack = cursorItemSlot.TakeAll();
                cursorItemSlot.InsertStack(clickedSlot.TakeAll());
                clickedSlot.itemSlot.InsertStack(tempStack);
            }
            return;
        }
    }
